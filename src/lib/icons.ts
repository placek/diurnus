...
const DEFS: IconDefinition[] = [faArrowUp, faBed, faBicycle, faBookBible, faBookOpen, faBrain, faBriefcase, faBroom, faCar, faCartShopping, faCheck, faChevronLeft, faChevronRight, faChild, faChurch, faCircle, faCircleHalfStroke, faCode, faCross, faDownload, faDumbbell, faEnvelope, faFilm, faGamepad, faGraduationCap, faGuitar, faHammer, faHandsPraying, faHeart, faHouse, faKeyboard, faLaptopCode, faListCheck, faMoon, faMountain, faMugHot, faMusic, faPenNib, faPersonRunning, faPhone, faPlus, faRotateLeft, faSeedling, faSliders, faStar, faSun, faTrashCan, faUpload, faUsers, faUtensils, faWandMagicSparkles, faXmark];
